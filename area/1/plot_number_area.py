...
data = np.loadtxt(file_location+r'\RGO_NOAA1874_2021\sn_train.txt')
area = data[:,-1].reshape(-1,1)
jul_date_area = np.loadtxt(file_location+r'\RGO_NOAA1874_2021\sn_train_jul_date.txt')
...
jul_date_sunspots = np.loadtxt(file_location+'\RGO_NOAA1874_2021\sn_train_jul_date.txt')
