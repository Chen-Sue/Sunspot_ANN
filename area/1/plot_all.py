...
model = tf.keras.models.load_model(file_location+\
    ...
    r'\00083-0.007365-0.085819-0.006810-0.082522.h5')

sunspot = np.genfromtxt(file_location+r'\RGO_NOAA1874_2021\sa_train.txt')
print(sunspot.shape)
...
jul_date = np.genfromtxt(file_location+r'\RGO_NOAA1874_2021\sa_train_jul_date.txt')
...
sunspot_pre = np.genfromtxt(file_location+r'\RGO_NOAA1874_2021\sa_pre.txt')
...
y_test_diff = (y_test_pre-y_test).reshape(-1,1)
...
ax.set_ylabel('月均太阳黑子面积', fontproperties=font, fontsize=18)  
...
ax.spines['right'].set_linewidth(1.5)
plt.tight_layout()
plt.savefig(r'D:\sunspot\figure\fig7(a).pdf', dpi=100)
plt.savefig(r'D:\sunspot\figure\fig7(a).jpg', dpi=100)
plt.show()
...
# plt.tight_layout()
# plt.savefig(r'D:\sunspot\fig9.png', dpi=100)
# plt.savefig(r'D:\sunspot\fig9.eps', dpi=100)
# plt.show()
