...
with open(file_location+r'\data1700_2021\sn_train{}.txt'.format(in_cycle*sun_epoch), 
    mode='w+', encoding='utf-8') as fout1:
    with open(file_location+r'\data1700_2021\sn_pre{}.txt'.format(in_cycle*sun_epoch), 
        mode='w+', encoding='utf-8') as fout2:
        for y in np.arange(config.min_year, config.max_year+1):          
            ...
            if datetime.datetime(y,1,1,0,0,0) > datetime.datetime(2020,1,1,0,0,0)\
                    ...
                    -relativedelta(years=in_cycle*sun_epoch):
                result = []
                for i in np.arange(0,in_cycle*sun_epoch+1,1):
                ...
                fout1.write('{} 1 1 {}\n'.format(y+in_cycle*sun_epoch, result)) 
                    ...
                    -relativedelta(years=in_cycle*sun_epoch) and \
